...
## Project Structure
    ...
    ├── testapiautostorybo_111267  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_111267`
...
2. Clone this repo and `cd testapiautostorybo_111267`
